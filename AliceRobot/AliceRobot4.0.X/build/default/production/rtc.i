...
void RTC_Init(void)
{
    ...
    I2C_Master_Write(0xD0u);
    I2C_Master_Write(0x07u);
...
void RTC_SetDateTime(rtc_t *rtc)
{
    ...
    I2C_Master_Write(0xD0u);
    I2C_Master_Write(0x00u);

    I2C_Master_Write(rtc->sec);
    I2C_Master_Write(rtc->min);
    I2C_Master_Write(rtc->hour);
    I2C_Master_Write(rtc->weekDay);
    I2C_Master_Write(rtc->date);
    I2C_Master_Write(rtc->month);
    I2C_Master_Write(rtc->year);
...
void RTC_GetDateTime(rtc_t *rtc)
{
    ...
    I2C_Master_Start();
    I2C_Master_Write(0xD1u);

    rtc->sec = I2C_Master_Read(0);
    rtc->min = I2C_Master_Read(0);
    rtc->hour= I2C_Master_Read(0);
    rtc->weekDay = I2C_Master_Read(0);
    rtc->date= I2C_Master_Read(0);
    rtc->month=I2C_Master_Read(0);
    rtc->year =I2C_Master_Read(1);
