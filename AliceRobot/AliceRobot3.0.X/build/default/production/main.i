...
# 42 "./uart.h"
volatile unsigned char _rx_buffer[64];
volatile unsigned char _tx_buffer[64];
...
# 1 "./variables.h" 1
# 25 "./variables.h"
extern volatile _Bool key_was_pressed;


extern volatile double tickL;
extern volatile double tickR;
...
# 15 "./driving.h"
    ...
    void set_pwm_duty_cycle_RC2_RightSlave(float duty);
    void set_pwm_duty_cycle_RC1_LeftMaster(float duty);
# 13 "main.c" 2
...
volatile float masterPower = 73.0;
volatile float slavePower = 73.0;
...
void __attribute__((picinterrupt(("")))) high_isr(void){
    ...
    if(TXIE && TXIF){
        if((_tx_buffer_tail != _tx_buffer_head)){
            ...
            _tx_buffer_tail = (unsigned char)(_tx_buffer_tail + 1) % 64;
            TXIF = 0;
        }else{
            TXIF = 0;
            TXIE = 0;
...
void portSetup(){
 ...
 void PWMSetup(){
    ...
    PR2 = (40000000 / (FREQUENCY * 4 * TIMER2_PRESCALER)) - 1;
